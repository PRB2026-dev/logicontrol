      ...
      <div className="hidden lg:flex lg:w-1/2 xl:w-[55%] relative items-center justify-center p-12 overflow-hidden">
        ...
        <div className="relative z-10 text-center max-w-lg">
          ...
          <div className="mb-8 flex items-center justify-center gap-5">
            <img src="/logo-main.png" alt="LogiControl" className="h-14 w-14 object-contain drop-shadow-[0_0_12px_rgba(59,130,246,0.4)]" />
            <div className="h-8 w-px bg-white/40 rounded-full" />
            <img src="/logo-bdp.png" alt="PSA BDP" className="h-14 object-contain drop-shadow-lg" />
          </div>
